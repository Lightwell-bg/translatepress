...
final class Language {
	...
	/**
	 * Короткий код языка для переключателя: `RU`, `EN`, `PT-BR`.
	 *
	 * Именно код языка, а не слаг и не локаль WordPress: слаг владелец
	 * сайта может задать любой (`/en/` против `/english/`), а `ru_RU`
	 * посетителю ничего не говорит.
	 */
	public function switcherCode(): string {
